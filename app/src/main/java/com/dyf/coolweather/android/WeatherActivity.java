...
import com.dyf.coolweather.android.gson.Forecast;
import com.dyf.coolweather.android.gson.Weather;
import com.dyf.coolweather.android.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    String weatherId = "CN101210101"; //默认杭州
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weather_f);
        //初始化 各空间
    ...
    public void requestWeather(final String weatherId){
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=36f830adb42c47bf96d9cb414c86e20d";
